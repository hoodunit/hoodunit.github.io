...
-----
Update 2014-2-18: I did some more testing and I was able to get Clojure on Android start times down to about 1.7 seconds by removing the lein-droid default splash screen and neko code (and using a Nexus 5 phone). This is about 6.8x slower than the standard Android Hello World startup. See the [original benchmark](https://github.com/hoodunit/thesis_experiments/tree/master/clojure_dalvik/hello_world) and the [updated benchmark](https://github.com/hoodunit/thesis_experiments/tree/master/clojure_dalvik/profiling).
